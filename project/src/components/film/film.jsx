          ...
          <div className="film-card__wrap">
            <div className="film-card__desc">
              ...
              <div className="film-card__buttons">
                ...
                <Link href="add-review.html" className="btn film-card__button">Add review</Link>
              </div>
            </div>
          </div>
        </div>
              ...
              <nav className="film-nav film-card__nav">
                <ul className="film-nav__list">
                  <li className="film-nav__item film-nav__item--active">
                    <Link href="#" className="film-nav__link">Overview</Link>
                  </li>
                  <li className="film-nav__item">
                    <Link href="#" className="film-nav__link">Details</Link>
                  </li>
                  <li className="film-nav__item">
                    <Link href="#" className="film-nav__link">Reviews</Link>
                  </li>
                </ul>
              </nav>
